...
public class Zoo {
    ...
    /**
     * Method for adding animals to the zoo from the specified JSON/XML file
     *
     * @param filePath path to JSON/XML file with animals info
     * @param configType type of file with animals info
     */
    public void addAnimals(String filePath, String configType) {
        ObjectMapper mapper = defineMapper(configType);
